...
class StoryBrain {
  ...
  String getStory() {
    return _storyData[_choiceNumber].storyTitle;
  }

  String getChoice1() {
    return _storyData[_choiceNumber].choice1;
  }

  String getChoice2() {
    return _storyData[_choiceNumber].choice2;
  }

  void nextStory() {
    if (_choiceNumber < _storyData.length - 1) {
      _choiceNumber++;
    }
  }
